        ...
        stage('Build')
        {
            steps {
    		    ...
    		    sh '''
    		        ...
    		        echo "Build of color-linez-com was successful"
    		        '''
            }
        }
    		    ...
    		    sh '''
    		        ...
    		        case $BRANCH_NAME in
    		          ...
    		          master)
                        ...
                        rsync --exclude '.git/*' -vaz ./ $WWW_ROOT_DIR/../www.colorlinez.com
                        echo "Deployment of documentation was successful. Env=production"
        		        ;;
    		        
      		          develop | jenkins)
        		        echo Branch $BRANCH_NAME is supported. Continuing.
                        rsync --exclude '.git/*' -vaz ./ $WWW_TEST_ROOT_DIR/../www.colorlinez.com
